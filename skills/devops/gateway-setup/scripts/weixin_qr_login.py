...
Requirements: aiohttp, cryptography, qrcode, pyyaml
"""
import asyncio
import os
import sys
...
# ---------------------------------------------------------------------------
# CRITICAL: Windows async event loop fix
# Without this, asyncio.run() hangs silently on Windows when making
# network requests via aiohttp. The default ProactorEventLoop does not
# work with subprocess + aiohttp combinations.
# ---------------------------------------------------------------------------
