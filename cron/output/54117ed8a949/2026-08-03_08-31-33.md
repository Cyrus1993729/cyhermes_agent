  📊 最新金价: $4,134.60 | ¥901.27/克
  📈 综合评分: 39.3/100  🟠  |  置信度: 中置信 (62/100)
  🎯 本周建议: 维持观望  |  定投: 30%  |  体制: 混合体制

──────────────────────────────────────────────────────────────────
  【数据新鲜度】
──────────────────────────────────────────────────────────────────
  宏观环境: 上次更新 2026-07-25 （9天前）→ 权重衰减至 ██████░░ 80%
  央行行为: 上次更新 2026-07-08 （26天前）→ 权重衰减至 ████░░░░ 60%

──────────────────────────────────────────────────────────────────
  【信号全景图】

  ▲ 结构性锚（长期）:
    ➖ 宏观环境·fiscal_gpr      +0.0  美元3个月走强 1.6%
    ⚠️ 央行行为·pboc_reserves   -0.3  央行购金信号
    ➖ 央行行为·resilience      +0.0  黄金3月 -10.7%，美股3月 +3.9%

  ● 中期驱动（1-6月）:
    ⚠️ 宏观环境·real_yield      -2.0  TIPS实际收益率 2.41%，上升趋势
    ✅ 宏观环境·dxy             +1.5  美元指数 99.75（近1月走弱 1.1%）
    ⚠️ 宏观环境·fed_policy      -0.5  2Y-10Y利差 0.47%，利差正常化
    ⚠️ 技术趋势·ma_position     -2.0  金价跌破50周均线 $4,347，跌破200日均线 $4,479
    ➖ 技术趋势·trend_strength  +0.0  ADX=28，趋势强劲
    ✅ 情绪仓位·gsr             +1.0  金银比 71，正常区间
    ⚠️ 估值水平·gold_oil        -1.0  金油比 51，处于高位
    ✅ 地缘政治·贵金属分化           +1.0  金略跑赢银，Z=0.7

  △ 短期扰动（周度）:
    ⚠️ 技术趋势·macd            -1.0  周线MACD死叉（MACD=-111.0）
    ➖ 技术趋势·rsi             +0.0  周线RSI(14)=42，中性区间
    ⚠️ 境内需求·上海溢价            -2.0  上海金折价 -6.5%
    ⚠️ 境内需求·境内ETF流量         -2.0  境内黄金ETF份额20日减少 36.4%
    ✅ 地缘政治·油金共振            +0.9  油金走势背离（Z=-0.95）
...
──────────────────────────────────────────────────────────────────
  ...
  💰 建议在 ¥896-935/克 暂停，等待回落至该区间再考虑
     （当前AU9999: ¥901.3，公允价值: ¥963.7，偏离: -6.5%）
==================================================================
```
...
本周金价核心驱动逻辑呈现"多空拉锯、偏空主导"格局。美联储 7 月会议按兵不动但内部分歧显性化（3 票支持加息），市场将此解读为短期利空出尽的释压反弹，金价在决议后短暂冲高至 $4,073 但随后回落（推断）。美元指数虽近一个月走弱 1.1%，为黄金提供了一定的计价支撑，但 TIPS 实际收益率高达 2.41% 且仍在上升趋势中，对零息资产黄金构成持续压制（来自模型 real_yield 信号 -2.0）。境内需求端尤为疲软——上海金折价 6.5%，境内黄金 ETF 份额 20 日净减少 36.4%，反映国内投资者看空情绪浓厚。美伊冲突虽已持续 150+ 天并推升油价至 $85+，但黄金未能获得显著的避险溢价——这与此前 Morgan Stanley 的判断一致：能源供应冲击降低了降息预期，强势美元和实际利率对冲了避险需求（推断）。

### 4.2 短期预判（1-4 周）

**模型信号指向**：综合评分 39.3/100，定投建议降至 30%，方向偏空。关键利空信号包括：周线 MACD 死叉（-111.0）、金价跌破 50 周均线（$4,347）和 200 日均线（$4,479）、上海金折价、境内 ETF 大幅流出。利多信号仅来自美元走弱和金银比处于正常区间。

**大行观点**：HSBC 预期 2026 年余下时间金价在 $3,800-$4,700 区间，年末 $4,750；JPMorgan 结构性看多至 $6,000（Q4 2026），认为央行购金和去美元化趋势未改；WGC 认为金价短期 ±5% 区间震荡，等待突破催化剂。多空分歧的核心在于：空方押注高利率持续压制估值，多方押注地缘与央行购金的长期结构性力量最终胜出。

**综合判断（推断）**：未来 1-4 周金价大概率在 $3,950-$4,250 区间震荡偏弱。核心假设：① 美联储 9 月会议前不会加息，但鹰派基调维持；② 美伊冲突不会突然大幅升级到威胁霍尔木兹海峡全面封锁的程度；③ 中国境内黄金需求在"金九银十"前维持低迷。若上述任一假设被打破（如 9 月意外加息或伊朗局势急剧恶化），区间将显著偏移。

### 4.3 操作建议

**定投策略（推断）**：模型建议定投比例降至 30%，即本周积存金定投按正常额度的 30% 执行。这不是清仓信号——已有持仓可继续持有，积存金作为长期配置资产的逻辑（央行购金、去美元化、全球不确定性）未变。

**加仓条件（推断）**：建议等待以下至少两个条件同时满足再考虑恢复满额定投：① 金价回落至 $3,950-$4,000 区间（约 ¥860-870/克）；② 上海金折价收窄至 -3% 以内（境内需求回暖信号）；③ 美联储释放明确的暂停加息或转向信号。

**长期持仓建议（推断）**：长期逻辑（央行购金 >1,000 吨/年、新兴市场去美元化、全球债务膨胀）依然有效。当前 39.3 分的低评分反映的是短期战术层面的谨慎，而非长期战略方向的改变。积存金投资者应利用金价回调阶段逐步积累仓位，而非追高。

---

## 【数据校验】

| 校验项 | API 来源 | API 值 | main.py 值 | 偏差 (main.py-API)/API | 判定 |
|:---|:---|:---|:---|:---|:---|
| 国际金价 | gold-api.com (XAU Spot) | $4,072.00 | $4,134.60 (GC=F 期货) | +1.54% | ✅ 正常（期货溢价） |
| USD/CNH 汇率 | exchangerate-api.com | 6.75 | 6.78 (硬编码¹) | +0.44% | ✅ 正常（见注释） |
| 人民币金价-API汇率口径 | 手动: $4,134.60÷31.1035×6.75 | ¥897.27 | ¥901.27 (main.py用6.78) | +0.45% | ✅ ≤3% |
| 人民币金价-同口径验证 | 手动: $4,134.60÷31.1035×6.78 | ¥901.25 | ¥901.27 (main.py) | +0.002% | ✅ 计算精度一致 |
| SGE 新鲜度 | — | 5天前 (2026-07-29) | 自动换算补充 | — | ✅ 正常 |
| FRED 完整性 | FRED API | DFII10 ✓, M2SL ✓, T10Y2Y ✓ | 全部成功 | — | ✅ 完整 |

> ¹ main.py 通过 yfinance 获取 CNH=X 汇率时 API 返回空数据（4次重试均失败），自动使用硬编码值 6.78。exchangerate-api.com 为独立校验源，当前值 6.75。偏差 +0.44% 在正常范围内。

> ² 分项评分加权计算：(-0.45×0.2)+(-1.05×0.15)+(0.20×0.1)+(-0.20×0.15)+(-0.12×0.2)+(-2.00×0.1)+(0.76×0.1) = -0.41，经模型内非线性映射后输出综合评分 39.3/100（0-100 刻度）。

---

*报告由 gold_analyzer/main.py v3.0 量化模型驱动，宏观/地缘信息来自 Reuters、Bloomberg、Federal Reserve、WGC 等公开来源。所有预判和建议均标注（推断），不构成投资建议。*

---

🔍 收尾自检：
✅ 步骤完整（D1-D4 全部交付） | ✅ 来源已区分（URL+推断标注） | ✅ 审查 CONDITIONAL（L1 4轮，0 FAIL，2 CONDITIONAL） | ✅ 已存档 → hermes_output/2026-08-03_gold_weekly.md | ✅ 复盘已存 → references/任务复盘/2026-08-03_gold_weekly.md | ⚠️ Opus 不可用（OAuth 过期），仅完成 L1 单层审查 | CNH=X yfinance API 不可达，使用硬编码汇率 6.78（偏差 +0.44%）
